...
![**Figure 1.** OISST data plotted on a Gnomic Cubic Sphere projection thanks to [Panoply](https://www.giss.nasa.gov/tools/panoply/).](avhrr-only-v2.19810901.png){width=100%}
...
nc.dir <- "/Volumes/Benguela/OceanData/OISSTv2/daily/netCDF"
...
csv.dir <- "/Volumes/Benguela/spatial/processed/OISSTv2/WBC/daily"
event.dir <- "/Volumes/Benguela/spatial/processed/OISSTv2/WBC/MHWs"
sst.dat <- fread(paste0(csv.dir, "/", "AC-avhrr-only-v2.19810901-20171019_sans_titles.csv"))
...
# clim switch selects either climatology or events as output
...
events <- as.data.table(ddply(sst.dat, .(lon, lat), OISST_detect, 
                              warm = TRUE, clim = FALSE,
...
fwrite(events, file = paste0("event.dir", "/", "AC-avhrr-only-v2.19810901-20171019_events.csv"))
