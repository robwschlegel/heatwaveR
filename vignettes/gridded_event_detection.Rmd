...
# Run this as only a few years at a time in case of errors
  # It may be necessary to reduce the number of files being loaded at once
OISST1 <- plyr::ldply(.data = OISST_files[1:1096], .fun = load_region, .parallel = T)
OISST2 <- plyr::ldply(.data = OISST_files[1097:2191], .fun = load_region, .parallel = T)
OISST3 <- plyr::ldply(.data = OISST_files[1:3652], .fun = load_region, .parallel = T, 
                      lon1 = 15, lon2 = 21, lat1 = -40, lat2 = -35)
