...
# Load the data in parallel
  # Note that it will take quite a while to load 30 years of data if each day is saved as a separate file
OISST <- plyr::ldply(.data = OISST_files, .fun = OISST_load, .parallel = T,
