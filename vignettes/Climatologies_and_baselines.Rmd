...
![**Figure 1.** Processing pipeline in the `detect()` algorithm with emphasis on the climatology and baseline procedures. The dark black arrows indicate the options that are currently available.](detect_diagram.svg){width=100%}
