...
attention is paid the finding ways to reduce the computational inefficiencies that stem
...
has an algorithm provided for it in the output of the `detect_event()` function.
...
The `detect_event()` function is the package's core function. Here is the `detect_event()` function applied to the Western Australian test data,
